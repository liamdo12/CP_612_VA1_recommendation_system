"""
Runner script to execute all three warm-start evaluation algorithms sequentially.
...
def main():
    ...
    print("="*80)
    print("WARM-START EVALUATION - ALGORITHM COMPARISON")
    print("="*80)
    ...
    if all_success:
        ...
        print("\nResults saved to:")
        print("  - datasets/output/model_implementations/svd_warm_start.csv")
        print("  - datasets/output/model_implementations/item_based_cf_warm_start.csv")
        print("  - datasets/output/model_implementations/user_based_cf_warm_start.csv")
        print("\nYou can now compare these with your cold-start results!")
